        ...
        <div className="items-center lg:flex">
          <div className="w-full lg:w-1/2">
            <div className="lg:max-w-xl">
              <h1 className="text-4xl font-bold lg:text-5xl text-center text-primary flex flex-col gap-1 md:gap-3 capitalize">
                Create your online store in Less than <br /> 60 seconds!
              </h1>
              <p className="mt-6 text-primary text-center font-medium text-xl md:text-2xl w-5/6 mx-auto">
