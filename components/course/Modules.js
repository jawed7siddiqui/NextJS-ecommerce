    ...
    <section className="text-textColor">
      <div className="container mx-auto px-5 py-14">
        ...
        <div className="block md:hidden">
          {/* Module 1 */}
          <div className="text-center px-2 mb-16 text-textColor">
          ...
          <div className="flex flex-wrap sm:flex-no-wrap items-center justify-center w-full text-white my-16">
            <div className="w-full sm:w-2/3 px-5 py-6 rounded-t-sm  bg-textColor mx-4 relative">
              <h2 className="text-2xl sm:text-3xl font-medium mt-2">
                Marketing Mindset Masterclass
              </h2>
              <div className="bg-primary text-[#193247] text-base font-medium py-2 px-4 rounded-md uppercase absolute top-0 -mt-5">
                <p>Module 1</p>
              </div>
            </div>
            <div className="w-full sm:w-2/3  rounded-b-sm bg-primaryLight mx-4 text-[#193247] p-4">
              <h2 className="text-lg sm:text-xl font-semibold mb-3 text-textColor">
                What you will learn:
              </h2>
              ...
              <h2 className="text-lg sm:text-xl font-semibold my-3 text-textColor">
